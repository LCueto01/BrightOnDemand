...
public class Part2Test extends TestBase {
  ...
  @Test
  public void testShowPlaylist() {// edited test to have comma
    videoPlayer.createPlaylist("my_playlist");
  ...
  @Test
  public void showPlaylistAfterRemoveAVideoFromPlaylistThenReAdd() {// added commas to tags
    videoPlayer.createPlaylist("mY_plaYList");
    videoPlayer.addVideoToPlaylist("mY_plaYList", "amazing_cats_video_id");
  ...
  @Test
  public void testRemoveFromPlaylistNonexistentVideo() {// fixed inconsistent print message
    videoPlayer.createPlaylist("my_playlist");
    videoPlayer.addVideoToPlaylist("my_PLAYlist", "amazing_cats_video_id");
    ...
    assertThat(lines[1], containsString("Added video to my_PLAYlist: Amazing Cats"));
    assertThat(lines[2],
        containsString("Cannot remove video from my_playlist: is not in playlist"));
  }
  ...
  @Test
  public void testClearPlaylist() {//added comma for tags, edited test didn't make sense
    videoPlayer.createPlaylist("my_playlist");
    videoPlayer.addVideoToPlaylist("my_playlist", "amazing_cats_video_id");
    videoPlayer.showPlaylist("my_playlist");

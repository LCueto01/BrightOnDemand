...
public class Part4Test extends TestBase {
  ...
  @Test
  public void testFlagVideoShowAllVideos() {// eddited video comma
    videoPlayer.flagVideo("amazing_cats_video_id", "dont_like_cats");
  ...
  @Test
  public void testFlagVideoSearchVideos() {// edited videos comma
    setInput("No");
  ...
  @Test
  public void testFlagVideoSearchVideosWithTag() {//eddited missing comma
    setInput("No");
  ...
  @Test
  public void testFlagVideoKeepVideoPlayingIfDifferentFromFlaggedVideo() {// edited video comma
    videoPlayer.playVideo("amazing_cats_video_id");
  ...
  @Test
  public void testAllowVideoShowPlaylist() {// edited video comma
    videoPlayer.createPlaylist("my_playlist");
    videoPlayer.addVideoToPlaylist("my_playlist", "amazing_cats_video_id");
    videoPlayer.flagVideo("amazing_cats_video_id", "dont_like_cats");
    videoPlayer.showPlaylist("my_playlist");
